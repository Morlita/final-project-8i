...
function Notes({ recipeId, reloadFlag, setReloadFlag, recipeFaved, location }) {
    ...
    return (
        <div className='container' id='notes-wrapper'>
            {result && result ? <div><h3 className=" text-center my-3 py-2 rounded">Mis Notas</h3></div> : false}
            <div className="d-flex flex-wrap justify-content-around">
                {notesFilterUser && notesFilterUser.map((item, index) => (
                    <div className="note" key={index} style={{ transform: `rotate(-3deg)` }}>
                        <div className="d-flex justify-content-end mb-3">
                            <button className="p-1 close mx-1" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => setIndex(index)}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pen" viewBox="0 0 16 16">
                                    <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z" />
                                </svg>
                            </button>
                            <button className="p-1 close" type="button" onClick={() => deleteNote(index)}>
            ...
            <div className='text-center p-4'>
                <button type='button' className="btn btn-danger rounded-pill" onClick={addNote}>Agregar nota</button>
            </div>
            {/* {result && result ?
