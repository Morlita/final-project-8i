  ...
  return (
    <div className="d-flex flex-column form-contact w-100 w-md-50">
      ...
      <div className="d-flex justify-content-end w-100">
        <textarea type="text" name="step" className="w-100" data-index={index} value={step} onChange={stepValue} maxLength="500" placeholder="Mezclar la harina en un bowl junto al azúcar" ></textarea>
