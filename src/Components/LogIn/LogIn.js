...
function Login() {
    ...
    return (
        ...
        <div className="container mt-4 login-component rounded px-4 py-2 d-grid col-md-7 col-10 mb-5">
            <h3 className="text-center pt-2">Bienvenido de nuevo!</h3>
            <h1 className="text-center py-2 h2 my-4 rounded">Completá tus datos para ingresar</h1>
            <form id="formLogIn mt-3">
                ...
                <div className="text-center p-2">
                    <p className=" mb-1">Si todavía no te registraste, ingresá aquí:</p>
