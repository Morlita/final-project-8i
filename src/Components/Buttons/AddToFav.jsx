...
function AddToFav({recipeId}) {
    ...
    return (
        <div>
            <button type="button" className="btn rounded-pill btn-outline-danger m-1 shadow" onClick={handleAddToFav}><i class="bi bi-bookmark-heart"></i> <span className='d-none d-md-block'>Guardar</span></button> 
        </div>
    )
}
