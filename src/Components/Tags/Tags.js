    ...
    return(
        <div className="tag-component">
            ...
            <div className="d-flex flex-row">
                {tags.map((item, index) => (
                    <div>
                        <svg key={index} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hash d-inline-flex" viewBox="0 0 16 16">
                        ...
                        <p>{item}</p>
                        <label><input type="checkbox" className="ms-auto"/></label>
                    </div>
                ))}
            </div>
        </div>
