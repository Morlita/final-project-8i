...
function Tags() {
    ...
    return (
        <div className="d-flex justify-content-sm-center justify-content-md-start text-uppercase tag-acordeon w-75">
            <div className="container rounded pb-5">
