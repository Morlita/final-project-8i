...
function Tags(){
    ...
    return(
        <div className="tag-component">
            <h2 className="d-flex justify-content-center">hashtags</h2>
            <div className="d-flex flex-column">
                {tags.map((item, index) => (
                    <div key={index}>
                        <svg  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-hash d-inline-flex" viewBox="0 0 16 16">
                        ...
                        <p className="d-inline-flex">{item}</p>
